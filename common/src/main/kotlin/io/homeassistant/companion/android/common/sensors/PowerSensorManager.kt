...
class PowerSensorManager : SensorManager {
    companion object {
        ...
        val interactiveDevice = SensorManager.BasicSensor(
            ...
            "mdi:cellphone",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#interactive-sensor",
        ...
        val doze = SensorManager.BasicSensor(
            ...
            "mdi:sleep",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#doze-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC,
            updateType = SensorManager.BasicSensor.UpdateType.INTENT,
        )
        val powerSave = SensorManager.BasicSensor(
            ...
            "mdi:battery-plus",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#power-save-sensor",
            entityCategory = SensorManager.ENTITY_CATEGORY_DIAGNOSTIC,
            updateType = SensorManager.BasicSensor.UpdateType.INTENT,
        )
    }

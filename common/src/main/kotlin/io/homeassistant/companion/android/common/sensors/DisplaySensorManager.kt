...
class DisplaySensorManager : SensorManager {
    companion object {
        val screenBrightness = SensorManager.BasicSensor(
            ...
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#screen-brightness-sensor",
        )
        ...
        val screenOffTimeout = SensorManager.BasicSensor(
            ...
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#screen-off-timeout-sensor",
        )
        ...
        val screenOrientation = SensorManager.BasicSensor(
            ...
            "mdi:screen-rotation",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#screen-orientation-sensor",
        ...
        val screenRotation = SensorManager.BasicSensor(
            ...
            "mdi:screen-rotation",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#screen-rotation-sensor",
            unitOfMeasurement = "°",
        )
    }
    ...
    override fun docsLink(): String {
        return "https://docs.cofarmer.enkitek.eu/docs/core/sensors#display-sensors"
    }

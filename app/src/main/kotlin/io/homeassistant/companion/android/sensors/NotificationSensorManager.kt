...
class NotificationSensorManager :
    ...
    companion object {
        ...
        val lastNotification = SensorManager.BasicSensor(
            ...
            "mdi:bell-ring",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#last-notification",
        ...
        val lastRemovedNotification = SensorManager.BasicSensor(
            ...
            "mdi:bell-ring",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#last-removed-notification",
            updateType = SensorManager.BasicSensor.UpdateType.INTENT_ONLY,
        )
        val activeNotificationCount = SensorManager.BasicSensor(
            ...
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#active-notification-count",
        ...
        private val mediaSession = SensorManager.BasicSensor(
            ...
            "mdi:play-circle",
            deviceClass = "enum",
            docsLink = "https://docs.cofarmer.enkitek.eu/docs/core/sensors#media-session-sensor",
        )
    }

    override fun docsLink(): String {
        return "https://docs.cofarmer.enkitek.eu/docs/core/sensors#notification-sensors"
    }
